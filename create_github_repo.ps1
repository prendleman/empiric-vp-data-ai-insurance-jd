...
param(
    ...
    [string]$RepoName = "empiric-vp-data-ai-insurance-jd",
    
    [Parameter(Mandatory=$false)]
    [string]$Description = "Job description repository for Empiric Vice President of Data & AI - Insurance position",
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host ""
    Write-Host "You can share this link!" -ForegroundColor Green
